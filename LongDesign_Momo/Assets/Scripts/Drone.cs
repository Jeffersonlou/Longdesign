...
public class Drone : MonoBehaviour
{
    ...
    {
        Vector3 testPosition = (transform.position + (transform.forward * 40f)) +
                               new Vector3(UnityEngine.Random.Range(-45f, 45f), 0f,
                                   UnityEngine.Random.Range(-45f, 45f));

        _destination = new Vector3(testPosition.x, 10f, testPosition.z);
